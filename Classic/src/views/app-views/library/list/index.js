...
const List = (props) => {
  ...
  const deleteItem = (id) => {
    confirm({
      ...
      cancelText: "Hủy bỏ",
      onOk() {
        new LibraryApi().delete({ id: id }).then((response) => {
  ...
  const viewItem = (id) => {
    history.push(`/lms/modules/mystudies/library/edit/${id}/overview`);
  };

  const addItem = () => {
    history.push(`/lms/modules/mystudies/library/add`);
  };
                                              ...
                                              >
                                                ...
                                                <td className="ant-table-cell ">
                                                  <div>
                                                    ...
                                                    <div className="mb-0">
                                                      <Link
                                                        to={`/lms/modules/mystudies/library/edit/${item.id}/overview`}
                                                        style={{ fontSize: 16 }}
                                                      >
                                                        [{item.id}]-{item.name}
                                                      </Link>
