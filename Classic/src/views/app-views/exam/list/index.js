...
const ExamList = (props) => {
  ...
  const deleteItem = (id) => {
    confirm({
      ...
      cancelText: "Hủy bỏ",
      onOk() {
        new ExamApi().delete({ id: id }).then((response) => {
  ...
  const viewItem = (id) => {
    history.push(`/lms/modules/mystudies/exams/edit/${id}/overview`);
  };

  const addExam = () => {
    history.push(`/lms/modules/mystudies/exams/add`);
  };
      ...
      <PageHeaderAlt className="border-bottom">
        <div className="container-fluid">
          <Flex justifyContent="between" alignItems="center">
            <h4 style={{ marginBottom: 0 }}>Kỳ thi </h4>
          </Flex>
        </div>
      </PageHeaderAlt>
                ...
                <div className="container-fluid">
                  <Row>
                    ...
                    <Col span={6} style={{ textAlign: "right" }}>
                      <Button onClick={() => addExam()} type="primary">
                        <PlusOutlined />
                        <span>Tạo mới</span>
                      </Button>
                    </Col>
                                              ...
                                              >
                                                ...
                                                <td className="ant-table-cell ">
                                                  <div>
                                                    ...
                                                    <div className="mb-0">
                                                      <Link
                                                        to={`/lms/modules/mystudies/exams/edit/${item.id}/overview`}
                                                        style={{ fontSize: 16 }}
                                                      >
                                                        [{item.id}]-{item.name}
                                                      </Link>
