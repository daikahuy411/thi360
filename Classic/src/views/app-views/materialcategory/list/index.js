...
import { MaterialCategoryApi } from "api/catalog-api";
...
class CategoryList extends React.Component {
  ...
  fetchData = () => {
    MaterialCategoryApi.getAll().then((response) => {
  ...
  delete = (fetchData) => {
    ...
    confirm({
      ...
      cancelText: "Hủy bỏ",
      onOk() {
        MaterialCategoryApi.delete(item).then((response) => {
        ...
        <PageHeaderAlt className="border-bottom">
          <div className="container-fluid">
            <Flex justifyContent="between" alignItems="center">
              <h4 style={{ marginBottom: 0 }}>Danh mục Học liệu</h4>
              <div></div>
            </Flex>
          </div>
        </PageHeaderAlt>
