...
const FileDialog = (props) => {
      ...
      <div className="ant-upload ant-upload-drag">
        <span className="ant-upload ant-upload-btn" role="button">
          <div className="ant-upload-drag-container">
            <div>
              <div>
                <span role="img" className="anticon display-3">
                  {props.fileUrlObject == null && (
 ...
 l279.663,941.308H163.033V1011.756z"></path>
                        ...
                        <path fill="#99E6FC" d="M163.033,680.979L68.355,196.393l94.678-18.501l143.802-23.615l62.994,584.599L163.033,680.979z"></path>
                        <g id="XMLID_159_">
                          <g>
 ...
 v502.692H950.933z"></path>
                          <path fill="#FDB441" d="M409.978,221.965H239.354c-7.12,0-12.896,5.774-12.896,12.896v502.692h183.52V221.965z"></path>
 ...
 c-45.72-6.231-92.605,0.192-135.379,19.061l-48.141,21.226v61.71c-0.003,5.451,4.421,9.875,9.874,9.875V866.397z"></path>
                  ...
                  {props.fileUrlObject != null && (
                    <img src={props.fileUrlObject.url} width="100%" />
                  )}
                </span>
                <p>Bấm vào để chọn file</p>
              </div>
            </div>
          </div>
        </span>
