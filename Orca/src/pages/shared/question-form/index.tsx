    ...
    return (
        ...
        >
            <>
                ...
                <Grid container>
                    <Grid item md={12} alignContent={'right'} alignItems={'right'} style={{ display: 'flex', justifyContent: 'flex-end', paddingRight: '5px' }}>
                        <Button
                            color='primary'
                            type='submit'
                            variant='contained'
                    ...
                    <Grid item md={12} style={{ width: 360 }}>
                        ...
                        <div style={{ padding: '10px', overflowY: 'scroll', height: `calc(100vh - 130px)` }}>
                            <Grid container spacing={5} style={{ paddingBottom: '20px' }}>
                                <Grid item xs={12}>
                                    <b>Loại câu hỏi: <Chip icon={<Icon icon='mdi:category' />} label={typeName} color="info" variant="outlined" className='chip-square' /></b>
                                </Grid>
                            </Grid>
                                ...
                                {(currentQuestion.questionTypeId !== QuestionType.SA && currentQuestion.questionTypeId !== QuestionType.GQ) && (
                                    <>
                                        <Grid container spacing={5} style={{ paddingBottom: '20px', paddingTop: '10px' }}>
                                            <Grid item xs={12}>
                                                <Divider textAlign='left'> <b>Đáp án </b></Divider>
                                            </Grid>
                                        </Grid>
                                        <Grid container spacing={5} style={{ paddingBottom: '20px' }}>
                                            <Grid item xs={12}>
