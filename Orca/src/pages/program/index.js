          ...
          <Card variant="outlined" style={{ minHeight: 88 }}>
            <CardContent sx={{ p: theme => `${theme.spacing(3.25, 5.75, 6.25)} !important` }}>
              <Typography
                ...
                sx={{ fontSize: 16, color: '#1a2c47', fontWeight: 'bold', textDecoration: 'none' }} color="text.secondary" gutterBottom>
                {item.name}
              </Typography>
                ...
                <Grid item xs={12} sm={4}>
                  <StyledBox>
                    <Box sx={{ display: 'flex', alignItems: 'center', '& svg': { color: 'primary.secondary', mr: 2.75 } }}>
                      ...
                      <Typography variant='body2'>15 Môn</Typography>
                    </Box>
                  </StyledBox>
                </Grid>
                <Grid item xs={12} sm={4}>
                  <StyledBox>
                    <Box sx={{ display: 'flex', alignItems: 'center', '& svg': { color: 'primary.secondary', mr: 2.75 } }}>
                      <Icon icon='mdi:circle-small' fontSize={20} />
                      <Typography variant='body2'>15 bài</Typography>
                    </Box>
                  </StyledBox>
                </Grid>
                <Grid item xs={12} sm={4}>
                  <Box sx={{ display: 'flex', alignItems: 'center', '& svg': { color: 'primary.secondary', mr: 2.75 } }}>
                    <Icon icon='mdi:circle-small' fontSize={20} />
                    <Typography variant='body2'>15 đề thi</Typography>
                  </Box>
                </Grid>
              </Grid> */}
            </CardContent>
