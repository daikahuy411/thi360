          ...
          <CardContent>
            <Box sx={{ mb: 6 }}>
              ...
              >
                ...
                {!data?.emailConfirmed && <Typography sx={{ color: 'text.secondary' }}>Chưa xác nhận email</Typography>}
              </Box>
              <Box
                sx={{
                  display: 'flex',
            ...
            <div>
              ...
              >
                ...
                <Typography sx={{ color: 'text.secondary' }}>
                  {data?.organizationId > 0 && <span>{data?.organizationName}</span>}
                  {data?.organizationId == 0 && <i>Bạn đang là học viên tự do</i>}
                </Typography>
              </Box>
            </div>
          </CardContent>
