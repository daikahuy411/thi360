  ...
  return (
    <>
      <div className='grid-block vertical flex-none finger-tabs__tabs'>
        <Link
          className={`finger-tabs__tab flex-none ${router.asPath === `/apps/exam/${examId}/` ? 'is-active' : 'disabled'
            }`}
          title='Học viên'
          component={Link}
        ...
        {currentClass && currentClass.id > 0 ?
          <Link
            className={`finger-tabs__tab flex-none ${router.asPath === `/apps/exam/${examId}/items/` ? 'is-active' : 'disabled'
              }`}
            title='Môn thi'
            component={Link}
        ...
        {currentClass && currentClass.id > 0 ?
          <Link
            className={`finger-tabs__tab flex-none ${router.asPath === `/apps/exam/${examId}/users/` ? 'is-active' : 'disabled'
              }`}
            title='Học viên'
            component={Link}
        ...
        {currentClass && currentClass.id > 0 ?
          <Link
            className={`finger-tabs__tab flex-none ${router.asPath === `/apps/exam/${examId}/report/` ? 'is-active' : 'disabled'
              }`}
            title='Học viên'
            component={Link}
