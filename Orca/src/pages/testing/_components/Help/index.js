      ...
      <div className="ph3">
        <div style={{ fontSize: "0.9em" }} className="sysInsTest1">
          <div className="instructionSection">
            ...
            <ol>
              <li>
                Đồng hồ đếm ngược thời gian ở góc phải trên cùng màn hình của
                bạn sẽ hiển thị thời gian còn lại cho bạn hoàn thành bài thi.
                Khi hết hạn nộp bài, hệ thống sẽ tự động thu bài của bạn.
              ...
              <li>
                Bảng câu hỏi ở góc phải màn hình thế hiện câu hỏi được đánh số
                theo các trạng thái sau:
              ...
              <li style={{ listStyleType: "none" }}>
                Câu hỏi được đánh dấu xem sau giúp bạn có thể đánh dấu lại câu
                hỏi cần xem lại.
            ...
            <ol start="3">
              <li>
                ...
                <ol type="a">
                  <li>
                    Chọn vào số thứ tự câu hỏi ở Bảng cẩu hỏi bên phải màn hình.
                    Hệ thống sẽ chuyển bạn tới câu hỏi đó. Chú ý: khi đó hệ
                    thống không lưu đáp án của bạn đã chọn của câu hỏi hiện tại.
                  ...
                  <li>
                    Chọn vào "Lưu và Tiếp tục" để hệ thống lưu trả lời của bạn
                    với câu hỏi hiện tại và chuyển tiếp sang câu hỏi tuần tự
                    tiếp theo.
                  ...
                  <li>
                    Chọn vào "Đánh dấu để xem", hệ thống sẽ Đánh dấu câu hỏi
                    hiện tại và chuyển bạn sang câu hỏi tuần tự tiếp theo.
            ...
            <ol start="8">
              <li>
                ...
                Các phần thi của bài thi được hiển thị ở trên cùng của màn hình.
                Phần thi hiện tại sẽ được hiển thị nổi bật.
              </li>
              <li>
                Sau khi bạn chọn "Lưu và Tiếp tục" câu hỏi cuối cùng của một
                phần, bạn sẽ được tự động chuyenr sang câu hỏi đầu tiên của phần
                tiếp theo.
